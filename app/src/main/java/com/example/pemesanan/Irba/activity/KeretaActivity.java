...
public class KeretaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper = new DatabaseHelper(KeretaActivity.this);
        db = dbHelper.getReadableDatabase();

        final String[] asal = {"Jakarta", "Bandung", "Malang", "Yogyakarta", "Surabaya"};
        final String[] tujuan = {"Jakarta", "Bandung", "Malang", "Yogyakarta", "Surabaya"};
            ...
            public void onClick(View v) {
                ...
                if (sAsal != null && sTujuan != null && sTanggal != null && sDewasa != null) {
                    if ((sAsal.equalsIgnoreCase("jakarta") && sTujuan.equalsIgnoreCase("jakarta"))
                        ...
                        Toast.makeText(KeretaActivity.this, "Asal dan Tujuan tidak boleh sama!", Toast.LENGTH_LONG).show();
                    } else {
                        AlertDialog dialog = new AlertDialog.Builder(KeretaActivity.this)
                                .setTitle("Booking kereta sekarang?")
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        try {
                                            ...
                                            db.execSQL("INSERT INTO TB_HARGA (username, id_book, harga_dewasa, harga_anak, harga_total) VALUES ('" +
                                                    ...
                                                    hargaTotalAnak + "','" +
                                                    hargaTotal + "');");
                                            Toast.makeText(KeretaActivity.this, "Booking Success!", Toast.LENGTH_LONG).show();
                                            finish();
                                        } catch (Exception e) {
                                            Toast.makeText(KeretaActivity.this, e.getMessage(), Toast.LENGTH_LONG).show();
                                        }
                                    }
                                })
                    ...
                    Toast.makeText(KeretaActivity.this, "Mohon lengkapi data pemesanan!", Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    private void setupToolbar() {
        ...
        toolbar.setTitle("Mbuking Train");
    ...
    public void perhitunganHarga() {
        if (sAsal.equalsIgnoreCase("jakarta") && sTujuan.equalsIgnoreCase("bandung")) {
            ...
            hargaDewasa = 130000;
            hargaAnak = 40000;
        } else if (sAsal.equalsIgnoreCase("malang") && sTujuan.equalsIgnoreCase("surabaya")) {
            hargaDewasa = 90000;
            hargaAnak = 650000;
